                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1 user-name text-bold-700"><?= $_SESSION['username'] ?></span>
                            <span class="avatar avatar-online">
                                <!-- <img src="<?= base_url('app-assets/images/portrait/small/avatar-s-19.png') ?>" alt="avatar"> -->
                                <img src="https://ui-avatars.com/api/?length=1&&name=<?= $_SESSION['username'] ?>&&background=random&&bold=true&&font-size=0.7" alt="avatar">
                                <i></i>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?= base_url('user/profile/'.$_SESSION['id']) ?>">
