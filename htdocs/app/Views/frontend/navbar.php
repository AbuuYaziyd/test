<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper">
	<div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
		<ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
			<li class="<?= ($title == lang('app.welcome') ? 'active' : '') ?> nav-item">
				<a class="nav-link" href="<?= base_url() ?>">
					<i class="la la-home"></i>
					<span data-i18n="Dashboard"><?= lang('app.home') ?></span>
				</a>
			</li>
					...
					<li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i class="la la-folder-open"></i><span data-i18n="General">General</span></a>
						<ul class="dropdown-menu">
							...
							<li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i class="la la-puzzle-piece"></i><span data-i18n="Starter kit">Starter kit</span></a>
								<ul class="dropdown-menu">
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/horizontal-layout-1-column.html" data-toggle=""><span data-i18n="1 column">1 column</span></a>
									</li>
									<li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><span data-i18n="Content Det. Sidebar">Content Det. Sidebar</span></a>
										<ul class="dropdown-menu">
											<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-content-detached-left-sidebar.html" data-toggle=""><span data-i18n="Detached left sidebar">Detached left sidebar</span></a>
											</li>
											<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-content-detached-left-sticky-sidebar.html" data-toggle=""><span data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</span></a>
											</li>
											<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-content-detached-right-sidebar.html" data-toggle=""><span data-i18n="Detached right sidebar">Detached right sidebar</span></a>
											</li>
											<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-content-detached-right-sticky-sidebar.html" data-toggle=""><span data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</span></a>
											</li>
										</ul>
									</li>
									<li class="dropdown-divider"></li>
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-fixed-navigation.html" data-toggle=""><span data-i18n="Fixed navigation">Fixed navigation</span></a>
									</li>
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-fixed.html" data-toggle=""><span data-i18n="Fixed layout">Fixed layout</span></a>
									</li>
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-boxed.html" data-toggle=""><span data-i18n="Boxed layout">Boxed layout</span></a>
									</li>
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-static.html" data-toggle=""><span data-i18n="Static layout">Static layout</span></a>
									</li>
									<li class="dropdown-divider"></li>
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-light.html" data-toggle=""><span data-i18n="Light layout">Light layout</span></a>
									</li>
									<li data-menu=""><a class="dropdown-item" href="../../../starter-kit/rtl/horizontal-menu-template/layout-dark.html" data-toggle=""><span data-i18n="Dark layout">Dark layout</span></a>
									</li>
								</ul>
							</li>
