...
<head>
	...
	<!-- BEGIN: Theme CSS-->
	<link rel="stylesheet" type="text/css" href="<?= base_url('app-assets/css/plugins/loaders/loaders.min.css') ?>">
		...
		$(document).ready(function() {
			<?php if (session()->getFlashdata('type')) : ?>
				Swal.fire({
					...
					timer: "<?= (session()->getFlashdata('btn') ? false : 3000) ?>",
					showConfirmButton: "<?= (session()->getFlashdata('btn') ?? false) ?>",
