<div class="row">
                    ...
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="info"><?= $books ?></h3>
                                <h6><?= lang('app.totalBooks') ?></h6>
                            </div>
                            <div>
                                <i class="la la-book info font-large-2 float-right"></i>
                            </div>
                        </div>
            ...
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="warning"><?= $cat ?></h3>
                                <h6><?= lang('app.categories') ?></h6>
                            </div>
                            <div>
                                <i class="la la-lightbulb-o warning font-large-2 float-right"></i>
                            </div>
                        </div>
                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
    ...
    <div class="col-xl-3 col-lg-6 col-12">
        <a href="<?= base_url('subcat') ?>">
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="success"><?= $sub ?></h3>
                                <h6><?= lang('app.subcats') ?></h6>
                            </div>
                            <div>
                                <i class="la la-certificate success font-large-2 float-right"></i>
                            </div>
                        </div>
                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
    ...
    <div class="col-xl-3 col-lg-6 col-12">
        <a href="<?= base_url('sharh') ?>">
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="danger"><?= $sharh ?></h3>
                                <h6><?= lang('app.sharhs') ?></h6>
                            </div>
                            <div>
            ...
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="amber"><?= $author ?></h3>
                                <h6><?= lang('app.authors') ?></h6>
                            </div>
                            <div>
            ...
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="primary"><?= $hits ?></h3>
                                <h6><?= lang('app.visitors') ?></h6>
                            </div>
                            <div>
                                <i class="la la-dashboard spinner primary font-large-2 float-right"></i>
                            </div>
                        </div>
                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
