            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="<?= base_url() ?>">
                        ...
                        <h3 class="brand-text"><?= (session('maktaba_name')??APP_NAME) ?></h3>
                    </a>
                </li>
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i></a>
                        <div class="search-input">
                            <input class="input" type="text" placeholder="<?= lang('app.search') ?>..." tabindex="0" data-search="template-list">
                ...
                <ul class="nav navbar-nav float-right">
                    <!-- <li class="dropdown dropdown-language nav-item">
                        <a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link">
                            <i class="flag-icon flag-icon-<?= ($_SESSION['locale'] == 'en' ? 'us' : ($_SESSION['locale'] == 'sw' ? 'tz' : ($_SESSION['locale'] == 'ar' ? 'sa' : ''))) ?>"></i>
                            <span class="selected-language"></span>
                        </a>
                        <div aria-labelledby="dropdown-flag" class="dropdown-menu">
                            <a href="<?= base_url('locale/ar') ?>" class="dropdown-item"><i class="flag-icon flag-icon-sa"></i> العربية</a>
                            <a href="<?= base_url('locale/en') ?>" class="dropdown-item"><i class="flag-icon flag-icon-us"></i> English</a>
                            <a href="<?= base_url('locale/sw') ?>" class="dropdown-item"><i class="flag-icon flag-icon-tz"></i> Kiswahili</a>
                        </div>
                    </li> -->
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1 user-name text-bold-700"><?= $_SESSION['fname'] ?></span>
                            <span class="avatar avatar-online">
                                <!-- <img src="<?= base_url('app-assets/images/portrait/small/avatar-s-19.png') ?>" alt="avatar"> -->
                                <img src="https://ui-avatars.com/api/?length=1&&name=<?= session('fname') ?>&&background=random" alt="avatar">
                                <i></i>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?= base_url('user/profile/'.$_SESSION['user_id']) ?>">
                                <i class="ft-user"></i> <?= lang('app.profile') ?>
                            </a>
                            <a class="dropdown-item" href="<?= base_url('change/password') ?>">
                                <i class="ft-check-square"></i> <?= lang('app.changepassword') ?>
                            </a>
