                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3><b><?= lang('app.tanfidh') ?> - <?= $user['name'] ?></b>
                                ...
                                <?php endif ?>
                                <?php if (session('role') == 'mushrif' && $user['malaf'] == null) : ?>
                                    <a class="btn btn-outline-success box-shadow-2 round pull-right" href="<?= base_url('admin/add-mushrif/'.$user['id']) ?>"><?= lang('app.activate') ?></a>
                                <?php endif ?>
                            </h3>
                        </div>
