                                                    ...
                                                    <div class="addNew">
                                                        ...
                                                        <div class="row m-1">
                                                            <div class="col-md-5">
                                                                ...
                                                                <input type="date" name="tasrih_date[]" class="form-control" min="<?= date('Y-m-d') ?>" value="<?= $dt['extra'] ?>">
                                                            </div>
                                                            <div class="col-md-5">
                                                                <label for=""><b><?= lang('app.tanfidhEndDate') ?></b></label>
                                                                <input type="date" name="tanfidh_date[]" class="form-control" min="<?= date('Y-m-d') ?>"value="<?= $dt['value'] ?>">
                                                            </div>
                                                            <div class="col-md-2">
